# Objetos Geométricos & Renderizado 3D en Consola
...
> **Nota Importante:** Para la correcta visualización del Motor 3D, es obligatorio usar un emulador de terminal real (como Git Bash, Zsh, bash de Linux o la terminal de macOS). La consola integrada de IDEs como Eclipse o NetBeans no soporta los comandos ANSI necesarios.
